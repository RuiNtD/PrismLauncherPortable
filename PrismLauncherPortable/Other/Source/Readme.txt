...
user in an INI file next to PrismLauncherPortable.exe called PrismLauncherPortable.ini.
...
copy AppNamePortable.ini from this directory to PrismLauncherPortable.ini next to
PrismLauncherPortable.exe. The options in the INI file are as follows:
