...
user in an INI file next to PolyMCPortable.exe called PolyMCPortable.ini.
...
copy AppNamePortable.ini from this directory to PolyMCPortable.ini next to
PolyMCPortable.exe. The options in the INI file are as follows:
